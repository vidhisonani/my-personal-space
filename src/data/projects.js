...
export const projectData = [
    ...
    },
    {
        ...
        description: "Full-stack AI recipe generator with Google OAuth, MongoDB, and Groq AI. Features recipe history, favourites, PDF export, and secure backend API handling.",
        video: "/projects/chef-claude.mp4",
        image: "/projects/chef-claude.png",
        tags: ["React", "Node.js", "Express", "MongoDB", "Google OAuth", "Groq AI", "Tailwind CSS"],
