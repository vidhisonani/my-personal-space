...
function Footer() {
  ...
  return (
    <footer className="dark:bg-bg-dark bg-white w-full border-t border-gray-200 dark:border-accent py-4 shadow-lg shadow-gray-500 dark:shadow-sm">
      <div
        data-aos="fade-up"
        className="max-w-[95vw] md:max-w-[90vw] mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-accent"
      >
          ...
          <ul className="text-sm md:text-md grid grid-cols-1 md:grid-cols-2 gap-y-2 dark:text-white">
            {quickLinks.map(({ href, label }) => (
              <li key={href}>
                <a
                  href={href}
                  className="hover:underline hover:text-accent-light transition-colors duration-200"
                >
                  {label}
                </a>
              </li>
        ...
        <div className="md:col-span-1">
          ...
          <div className="flex gap-4 mt-4">
            <a
              ...
              className="w-8 h-8 flex items-center justify-center rounded-full border border-accent dark:border-accent-light text-accent dark:text-white hover:bg-accent hover:text-white hover:shadow-md hover:shadow-accent/40 hover:scale-110 transition-all duration-300"
            >
